...
public class Persona  implements java.io.Serializable {
    ...
    public Persona(String rut, String nombre, String apellido, Date nacimiento, String email, Long telefono, Set empresas, Set usuarios, Set comidas, Set paises, Set alojamientos) {
       this.rut = rut;
       this.nombre = nombre;
       this.apellido = apellido;
       this.nacimiento = nacimiento;
