...
public class P_Login extends javax.swing.JFrame {
    ...
    private UsuarioControlador _usuControl;
    public P_Login() {
        initComponents();
        this.setLocationRelativeTo(null);
        usuario = new Usuario();
        _usuControl= new UsuarioControlador();
    }
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        ...
        try {
            usuario = _usuControl.validarPerfil(nomUsuario,pass);
            ...
            if (usuario.getPerfil().equalsIgnoreCase("Administrador")) {
                ...
                JOptionPane.showMessageDialog(this,"Bienvenido "+usuario.getPersona().getNombre()+" "+usuario.getPersona().getApellido());
